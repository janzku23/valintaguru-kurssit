...
export default async function CourseTasksPage({ params }: Props) {
      ...
      <main className="min-h-screen bg-[#f5f8ff] px-6 py-16 text-slate-950">
        <div className="mx-auto max-w-3xl rounded-3xl bg-white p-8 shadow-sm">
          ...
          <h1 className="mt-3 text-3xl font-extrabold">
            Sinulla ei ole pääsyä kurssin {course.title} harjoituksiin
          </h1>

          <p className="mt-4 leading-8 text-slate-700">
            Nämä tehtävät kuuluvat kurssiin, joka ei ole tällä käyttäjällä
            käytössä.
          </p>
    ...
    <main className="min-h-screen bg-[#f5f8ff] px-4 py-8 text-slate-950 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 rounded-3xl bg-gradient-to-br from-blue-700 to-blue-500 p-8 text-white shadow-sm">
          <p className="font-semibold text-blue-100">{course.label}</p>

          <h1 className="mt-3 text-4xl font-extrabold">Harjoitukset</h1>

          <p className="mt-4 max-w-3xl text-lg leading-8 text-blue-50">
            Tämä näkymä näyttää vain kurssin {course.title} harjoitukset.
          </p>
        </header>

        <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
          <CourseMaterialSidebar course={course} activePage="tasks" />
          ...
          <section className="space-y-6">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-lg leading-8 text-slate-700">
                Tee vain tämän kurssin harjoituksia. Vastaukset tallentuvat
                kurssin edistymisnäkymään.
              </p>
            </div>

            <QuizView courseId={courseId} questions={content.quizQuestions} />
          </section>
        </div>
      </div>
    </main>
