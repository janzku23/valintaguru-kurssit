      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-12">
        <div className="rounded-[2rem] bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 p-6 text-white shadow-xl shadow-blue-900/15 sm:p-8 lg:p-10">
          ...
          <p className="mt-4 max-w-3xl leading-7 text-blue-50">
            YO-kurssi säilyy
            järjestelmässä, mutta sitä
            ei tällä hetkellä näytetä
            ostettavana.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-7 flex items-end justify-between gap-4">
                    ...
                    <a
                      href={
                        hasDirectPurchaseUrl
                          ? course.purchaseUrl
                          : HOLVI_STORE_URL
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center rounded-full bg-[#3f51e7] px-5 py-3 text-sm font-black text-white shadow-lg shadow-indigo-600/20 transition hover:bg-[#3142d6]"
                    >
                      {hasDirectPurchaseUrl
                        ? "Osta Holvista"
                        : "Avaa verkkokauppa"}
